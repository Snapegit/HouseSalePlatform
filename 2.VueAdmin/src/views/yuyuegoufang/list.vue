	...
	<div>
		<div class="app-contain">
			...
			<el-table
				...
				<el-table-column label="审核" v-if="btnAuth('yuyuegoufang','审核')" :resizable='true' :sortable='false' align="left" header-align="left">
					<template #default="scope">
				...
				<el-table-column label="操作" width="300" :resizable='true' :sortable='false' align="left" header-align="left">
					<template #default="scope">
						...
						<el-button v-if="btnAuth('yuyuegoufang','购买')" type="success" @click="goumaifangziCrossAddOrUpdateHandler(scope.row,'cross','是','','')">购买</el-button>
					</template>
				</el-table-column>
			</el-table>
			<el-pagination 
		...
		<goumaifangziFormModel ref="goumaifangziFormModelRef" @formModelChange="formModelChange"></goumaifangziFormModel>
	</div>
</template>
<script setup>
	...
	import goumaifangziFormModel from '@/views/goumaifangzi/formModel'
	const goumaifangziFormModelRef = ref(null)
    const goumaifangziCrossAddOrUpdateHandler = (row,type,crossOptAudit,statusColumnName,tips,statusColumnValue) => {
		...
		nextTick(()=>{
			goumaifangziFormModelRef.value.init(row.id,'cross','购买',row,'yuyuegoufang',statusColumnName,tips,statusColumnValue)
		})
    }
	//查询审核状态列表
